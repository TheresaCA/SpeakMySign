...
# Generate speech in Hindi using gTTS
def text_to_speech_hindi(text, filename="output_hindi.mp3"):
...
task_type = "sentence"  # or "sentence"
...
# Convert Hindi output to speech (save as an mp3 file)
text_to_speech_hindi(generated_output_hindi)
